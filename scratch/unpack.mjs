...
const htmlPath = path.join(process.cwd(), 'Agenda da Semana (standalone) (1).html');
const outputDir = path.join(process.cwd(), 'scratch', 'unpacked');
