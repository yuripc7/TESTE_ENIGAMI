...
function seedTasks() {
  const T = (o) => ({ status: 'todo', weight: 2, subtasks: [], ...o, dueDate: o.dueDate || dateForDay(o.day, 0) });
  return [
    ...
    T({ id: 6,  day: 'Terça', assignee: 'Cassio',   project: 'Itajaí - Viabilidade', disc: 'ARQ', weight: 3, status: 'doing', text: 'Estudo de massa volumétrica e implantação preliminar' }),
    ...
    T({ id: 9,  day: 'Terça', assignee: 'Yuri',     project: 'Miguel Res.',          disc: 'EST', weight: 3, status: 'todo',  text: 'Modelagem executiva da alvenaria (Pav. Tipo) e planta de forro' }),
    ...
    T({ id: 18, day: 'Quinta', assignee: 'Yuri',     project: 'Miguel Res.', disc: 'MEP', weight: 3, status: 'todo', text: 'Lançamento de elementos MEP (Elétrica e Hidráulica)' }),
