/* global React, Icon, PROJECTS, PEOPLE, DAYS, DAY_IDX, DISCIPLINES, STATUSES, dateForDay, addProject, addPerson, addDiscipline */
...
function TaskModal({ open, initial, weekOffset, onClose, onSave }) {
  const blank = { text: '', day: 'Segunda', assignee: 'Yuri', project: 'Geral', disc: 'ARQ', status: 'todo', weight: 2, durationDays: 1, time: '', dueDate: '', isCoordPoint: false, valid: 'pending', subtasks: [] };
